  ...
  return (
    <div className="header md-2">
      <Row className="pt-3">
        ...
        <Col md={4} sm={4} lg={5} className="mt-2 d-none d-md-block">
              ...
              <Row>
                <Col>
                  <Nav >
                    <NavDropdown title=
                      {
                        <span className="header-link" style={{ fontSize: '0.9rem' }}>
                ...
                <Col className="d-none d-md-block">
                  <Link to="/order" className="d-flex header-link">
                    <>
